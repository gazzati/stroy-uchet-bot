...
Проект находится на этапе проектирования MVP. Техническое задание и инженерная спецификация лежат в `docs/spec`.
...
MVP планируется реализовать на Node.js.
...
Кодовая база еще не создана. Сейчас зафиксированы требования, продуктовые решения MVP и предварительная архитектура.
